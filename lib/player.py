...
class Player(object):
    ...
    def __init__(self, _type, texture, shadow_texture, pos, angle, playable,
        ...
        self.lastIndexTrack = 0  # Último indice visitado en la pista, este indice se va incrementando a medida que el jugador avanza en la pista
    ...
    def collide(self, surface, t, **kwargs):
        """
        Comprueba colisiones con objetos, esto verifica si el jugador toca la tierra o no.
